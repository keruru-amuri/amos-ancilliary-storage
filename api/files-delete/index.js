...
const { getEntity, deleteEntity, deleteBlob, getEntityByRowKey } = storageService;
...
module.exports = async function (context, req) {
  try {
    ...
    if (!access.allowed) {
      context.res = createErrorResponse('You do not have permission to delete this file', 403);
      return;
    }
